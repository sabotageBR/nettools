...
public class NmapTO extends NettoolsTO{


	private static final long serialVersionUID = 7883962305931376592L;
	private String host;
	...
	public NmapTO(String host,String resultado) {
		setHost(host);
		setResultado(resultado);
	}
	
	public NmapTO(String host,LocalDateTime dateTime) {
		setHost(host);
