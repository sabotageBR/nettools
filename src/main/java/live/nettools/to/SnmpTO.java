...
public class SnmpTO extends NettoolsTO{
	...
	public SnmpTO(String host,String resultado) {
		setHost(host);
		setResultado(resultado);
	}
	
	public SnmpTO(String host,String porta,String oid,String versao,String community,  LocalDateTime dateTime) {
		setHost(host);
		setPorta(porta);
		setOid(oid);
		setVersao(versao);
