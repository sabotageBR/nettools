...
public class IsItDownTO extends NettoolsTO {

    private static final long serialVersionUID = 5400112879734505573L;
    ...
    public IsItDownTO(String host, String resultado) {
        setHost(host);
        setResultado(resultado);
    }

    public IsItDownTO(String host, LocalDateTime dateTime) {
        setHost(host);
