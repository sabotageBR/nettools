...
public class SslTO extends NettoolsTO {

    private static final long serialVersionUID = 5400112879734505574L;
    ...
    public SslTO(String host, String resultado) {
        setHost(host);
        setResultado(resultado);
    }

    public SslTO(String host, String porta, LocalDateTime dateTime) {
        setHost(host);
        setPorta(porta);
