...
public class PortCheckTO extends NettoolsTO {
    ...
    public PortCheckTO(String host, String resultado) {
        setHost(host);
        setResultado(resultado);
    }

    public PortCheckTO(String host, String porta, LocalDateTime dateTime) {
        setHost(host);
        setPorta(porta);
